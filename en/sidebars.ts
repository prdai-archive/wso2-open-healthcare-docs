  ...
  docsSidebar: [
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'get-started/open-healthcare-quickstart',
    ...
    },
    {
      ...
      items: [
        {
          type: 'doc',
          id: 'install-and-setup/manual',
          label: 'Manual Installation',
        },
        'install-and-setup/deploy-fhir-apis',
        'install-and-setup/fhir-artifacts',
        {
          type: 'category',
          label: 'Updates',
          items: [{ type: 'autogenerated', dirName: 'install-and-setup/updates' }],
        },
      ],
    },
    {
